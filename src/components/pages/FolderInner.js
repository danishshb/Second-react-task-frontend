...
function FolderInner() {
  const {handleAttachments, userData, tuFiles, tuFolder, fetchUserInfo, uploadAttachments, handleDownloadAttachment, deleteAttachment, creatFolder, renameAttachment } = useContext(AuthContext)
...
const handleChange = (e) => {
  ...
  setSFile(e.target.files.length > 1);
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="panelsFolders">
                        <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne">
                          <span>Folders</span><span>({tuFolder})</span>
                        </button>
                      </h2>
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="panelsFiles">
                        <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                          <span>Files</span><span>({tuFiles})</span>
                        </button>
                      </h2>
